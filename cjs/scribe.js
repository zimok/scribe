...
var enforcePElements = require('./plugins/core/formatters/html/enforce-p-elements');
var ensureSelectableContainers = require('./plugins/core/formatters/html/ensure-selectable-containers');
var escapeHtmlCharactersFormatter = require('./plugins/core/formatters/plain-text/escape-html-characters');
var inlineElementsMode = require('./plugins/core/inline-elements-mode');
var patches = require('./plugins/core/patches');
var setRootPElement = require('./plugins/core/set-root-p-element');
var Api = require('./api');
var buildTransactionManager = require('./transaction-manager');
var buildUndoManager = require('./undo-manager');
